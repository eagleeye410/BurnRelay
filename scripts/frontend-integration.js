 ...
 * This file demonstrates how to integrate Burnrelay with a web frontend
 */

// For React/Vue/Angular applications
export class BurnrelayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BurnrelayClient(provider, contractAddress);
